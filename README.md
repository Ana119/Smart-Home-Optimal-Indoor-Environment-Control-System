...
## 📁 Project Structure
```
ocf-smart-home-optimization/
│
├── 📁 Energy_Optimization_GreenHouse/       # Python optimization module
│   ├── __pycache__/
│   ├── models/                              # ADD: ML models
│   │   ├── lstm_energy_model.py
│   │   ├── lstm_environment_model.py
│   │   └── pmv_comfort_model.py
│   ├── optimization/                        # ADD: Optimization algorithms
...
│   └── README.md                            # ADD: Module documentation
│
├── 📁 IoTivity_Greenhouse_CoAP_Connections/ # Java IoTivity module
│   ├── bin/
│   │   ├── SQLDatabase/
│   │   └── com/mcl/app/
│   ├── src/
│   │   ├── SQLDatabase/
│   │   │   ├── DatabaseConnection.java      # ADD: DB connection
│   │   │   └── DataManager.java             # ADD: Data management
│   │   └── com/mcl/app/
│   │       ├── OCFClient.java               # ADD: OCF client
│   │       ├── OCFServer.java               # ADD: OCF server
│   │       ├── ResourceManager.java         # ADD: Resource handling
│   │       └── CoAPHandler.java             # ADD: CoAP protocol
│   ├── lib/                                 # ADD: Organize JARs
│   │   ├── iotivity-lite.jar
...
│   │   └── iotivity-config.json
│   ├── .classpath                           # Eclipse classpath
│   ├── .project                             # Eclipse project
│   ├── build.xml                            # ADD: Build configuration
│   └── README.md                            # ADD: Module documentation
│
├── 📁 raspberry-pi-device/                  # ADD: Raspberry Pi code
│   ├── ocf_server.py                        # OCF server implementation
│   ├── flask_server.py                      # Flask API server
│   ├── sensor_drivers/
│   │   ├── dht22_sensor.py
│   │   ├── anemometer.py
│   │   └── globe_thermometer.py
...
│   └── README.md
│
├── 📁 mobile-app/                           # ADD: Android application
│   ├── app/
│   │   ├── src/
│   │   │   ├── main/
│   │   │   │   ├── java/
...
│   │   ├── system-flow.png
│   │   ├── energy-savings-chart.png
│   │   └── rtt-comparison.png
│   └── paper/
│       └── published-paper.pdf
│
├── 📁 tests/                                # ADD: Test suites
│   ├── python/
...
│   └── backup_database.sh
│
├── 📁 config/                               # ADD: Global configurations
│   ├── config.yaml
│   ├── logging_config.yaml
│   └── .env.example
│
...
└── requirements.txt                         # ADD: Root requirements
```
